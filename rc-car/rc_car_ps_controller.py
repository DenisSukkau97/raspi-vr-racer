...
SHUTDOWN_HOLD_TIME = 3  # Sekunden gedrückt halten 
...
if __name__ == "__main__": 
    ...
    print("=== RC CAR – PS5 WITH SHUTDOWN ===") 
    ...
    while True: 
        ...
        try: 
            ...
            for event in gamepad.read_loop(): 
                ...
                # ───── BUTTON EVENTS ───── 
                    ...
                    if event.code == ecodes.BTN_MODE: 
                        ...
                        if event.value == 1:  # gedrückt 
                            ...
                            ps_pressed_time = time.time() 

 

                        elif event.value == 0:  # losgelassen 
                ...
                if ps_pressed_time is not None: 

                    if time.time() - ps_pressed_time > SHUTDOWN_HOLD_TIME: 
